...
class TestTaskPackedPickingWizard(models.TransientModel):
    ...
    def action_create_picking(self):
        ...
        try:
            ...
            raise ValueError(_(f"An error occurred while creating the picking: {e}"))
    ...
    def _notify_responsible_user(self, picking):
        ...
        _logger.info(f"Notification sent to responsible user ID: {self.responsible_user_id.id}")
...
class TestTaskPackedPickingLineWizard(models.TransientModel):
    """ Line wizard for specifying products and quantities in packed picking creation. """
